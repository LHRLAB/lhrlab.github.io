...
\section{Papers}
\resumeSubHeadingListStart
  \resumeSubItem{ChatKBQA}{A Generate-then-Retrieve framework for Knowledge Base QA (ACL 2024).}
  \resumeSubItem{Text2NKG}{N-ary relation extraction for KG construction (NeurIPS 2024).}
  \resumeSubItem{HyperGraphRAG}{Structured retrieval and reasoning with hypergraph-based RAG (under review at NeurIPS 2025).}
  \resumeSubItem{Graph-R1}{Structured retrieval and reasoning with hypergraph-based RAG (under review at NeurIPS 2025).}
\resumeSubHeadingListEnd
